    ...
    local_getJson = function(element){
        ...
        if (element){
            json =  {
                ...
                origenCompleto : element.get("CiudadOrigen").get("Nombre") + " - " + element.get("DireccionOrigen"),
                destino : element.get("CiudadDestino").get("Nombre"),
                destinoDireccion : element.get("DireccionDestino"),
                destinoCompleto : element.get("CiudadDestino").get("Nombre") + " - " + element.get("DireccionDestino"),
